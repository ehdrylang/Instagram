insert into board (author, content, createdDate, modifiedDate) values ('test1@gmail.com', '테스트1의 본문', now(), now());
insert into board (author, content, createdDate, modifiedDate) values ('test2@gmail.com', '테스트2의 본문', now(), now());
